    ...
    <>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-stone-900 bg-stone-900 p-6 text-white sm:p-8">
              <h3 className={`${displayFont.className} text-3xl font-extrabold leading-[1.1] tracking-[-0.03em] sm:text-4xl`}>
            ...
            <div className="rounded-2xl border border-stone-200 bg-stone-50 p-6 sm:p-8">
              <h3 className={`${displayFont.className} text-3xl font-extrabold leading-[1.1] tracking-[-0.03em] text-stone-900 sm:text-4xl`}>
      ...
      <section className="border-t border-stone-200 bg-stone-50">
        <div className="mx-auto w-full max-w-3xl px-4 py-16 text-center sm:px-6 lg:py-20">
          <h2 className={`${displayFont.className} text-4xl font-extrabold leading-[1.08] tracking-[-0.03em] text-stone-900 sm:text-5xl`}>
            {t("landing.ctaTitle")}
          </h2>
