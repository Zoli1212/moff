...
export default function WorksLayout({ children }: { children: React.ReactNode }) {
  ...
  const menu = [
    ...
    { href: "/works/tasks", label: "Feladatok", icon: (
    ...
    { href: "/works/accounts", label: "Beszámoló", icon: (
    ...
    { href: "/works/diary", label: "Napló", icon: (
    ...
    { href: "/works/others", label: "Egyéb", icon: (
