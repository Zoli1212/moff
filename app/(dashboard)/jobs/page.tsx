  ...
  const fetchWorks = useCallback(async () => {
    try {
      ...
      const worksWithDates = data.map(work => ({
        ...work,
        date: work.date instanceof Date ? work.date : new Date(work.date as unknown as string),
        createdAt: work.createdAt instanceof Date ? work.createdAt : new Date(work.createdAt as unknown as string),
